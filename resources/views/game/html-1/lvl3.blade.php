...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/uikit@3.7.2/dist/css/uikit.min.css" />
    ...
    <section id="game">
        <div class="row">
            <div class="col-md-6">
                ...
                <h4 class="text-center" style="top:0;">Susun code dibawah ini ke box editor untuk dapat menampilkan output seperti pada gambar dibawah ini</h4>
                ...
                <div class="uk-flex uk-flex-center">
                    ...
                    <div class="dragAndDrop" ondrop="drop007(event)">
                        <div ondragstart="dragStart007(event)" draggable="true" id="target007"><p class="choice">&lt;p&gt;</p></div>
                    </div>
                    <div class="dragAndDrop" ondrop="drop008(event)">
                        <div ondragstart="dragStart008(event)" draggable="true" id="target008"><p class="choice">Hello World</p></div>
                    </div>
                    <div class="dragAndDrop" ondrop="drop009(event)">
                        <div ondragstart="dragStart009(event)" draggable="true" id="target009"><p class="choice">&lt;/p&gt;</p></div>
                    </div>
                </div>
                <div class="text-center">
                    <img src="{{ asset('img/soal 2-05.png') }}" alt="">
                </div>
            </div>
            <div class="col-md-6">
    ...
    <script>
        ...
        b++;
            ...
            function submit001() {
                if (b > 8) {
                    nxt.innerHTML = "<a href='{{ route('game.html1.end',$materi->id) }}' style='margin-left:20px;' class='uk-button uk-button-danger btn-next'>Next</a>";
